...
description: Inline Actions to External Contracts
sidebar_position: 7
...
* [Linking Custom Permissions](/zero/smart-contract-tutorials/linking-custom-permission): Learn how create a custom permission and how to link the permission to an action of a contract.
