...
description: Creating & Linking Custom Permissions
sidebar_position: 8
...
* [Payable Actions](/zero/smart-contract-tutorials/payable_actions): Learn how to write a smart contract that has payable actions.&#x20;
