...
The constructor initializes the hodl\_symbol as “SYS”, which is a token created in the [Deploy, Issue and Transfer Tokens](/zero/smart-contract-tutorials/deploy-issue-and-transfer-tokens) section.
