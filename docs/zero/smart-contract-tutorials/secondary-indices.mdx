...
* [Adding Inline Actions](/zero/smart-contract-tutorials/adding-inline-actions): Learn how to construct actions and send those actions from within a contract.
