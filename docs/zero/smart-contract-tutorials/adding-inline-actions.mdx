...
description: Adding Inline Actions
sidebar_position: 6
...
* [Inline Actions to External Contracts](/zero/smart-contract-tutorials/inline-action-to-external-contract): Learn how to construct actions and send those actions to an external contract.
