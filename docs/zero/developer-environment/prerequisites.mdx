...
description: Prerequisites to setting up your Telos dev environment
sidebar_position: 1
...
## What's Next?
- [Installing Antelope.io](/zero/developer-environment/installing-antelope): Steps to download and install binaries on your system.