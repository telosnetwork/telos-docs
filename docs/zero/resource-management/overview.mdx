...
| Title | Description |
| :--- | :--- |
| [**How to purchase CPU-NET**](/zero/resource-management/cpu-net) | Learn how to add CPU and NET to your account. |
| [**How to purchase RAM**](/zero/resource-management/ram) | Learn how to add RAM to your account. |