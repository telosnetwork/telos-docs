...
* [Getting Started](/zero/developer-environment/prerequisites): Install the Antelope platform in your local development environment.
...
<img
    src={require('/static/img/EOSIO-Overview-dev (1).png').default}
    alt="Antelope Development Lifecycle"
    width="70%"
    height="automatic"
/>
