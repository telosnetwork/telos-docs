...
For more information on how to create an account, click [here](/zero/about/accounts#creating-an-account).
...
<iframe width="750" height="422" src="https://www.youtube.com/embed/_I0dUL4kpTg" title="What is a “Smart Contract”?" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
