...
title: Understanding Telos Decide
sidebar_position: 1
hide_table_of_contents: true
---

# Understanding Telos Decide
...
- [Treasuries](/zero/governance/decide/treasuries)
- [Ballots](/zero/governance/decide/ballots)
- [Voting](/zero/governance/decide/voting)
- [Contract Integration](/zero/governance/decide/contract-integration)
- [Payrolls](/zero/governance/decide/payrolls)
- [Workers](/zero/governance/decide/workers)
