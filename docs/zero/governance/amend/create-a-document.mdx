...
| document_name | name | doc1 | The name identifier for the document |
| author | name | testaccount1 | The telos account of the author |
| initial_sections | map&lt;name, string&gt; | `{sectiona: "Text here", sectionb: "More text here", sectionc: "A little more text"}` ... | The document is broken down into a mapping of section names to section content. |
