...
title: "Scalability"
description: >-
    Learn how Telos scales,
    solving one of blockchains 
    biggest problems
sidebar_position: 4
...
Blockchains have an issue [with state bloat](https://blocking.net/blockchain-state-explosion-dilemma-hard-core-series.html). If there is no way to reduce the cumulative state of all past transactions, the blockchain state grows out of the capabilities of commodity hardware. This in turn will increase the capital cost of running a node and lead to more centralization.
