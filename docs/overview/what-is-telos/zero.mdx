...
description: >-
    ...
    Zero and the incredible features
    it has!
...
Transfer from Zero to EVM by following this guide [Withdraw, Transfer, and Send TLOS](/quickstart/zero/withdraw-transfer-and-send-tlos)