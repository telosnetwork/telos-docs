...
<img
    src={require('/static/img/grab_contract_address.png').default}
    alt="remix"
    width="70%"
    height="automatic"
/>
...
<img
    src={require('/static/img/getsourcify.jpg').default}
    alt="remix"
    width="70%"
    height="automatic"
/>
...
<img
    src={require('/static/img/remix_sourcify.png').default}
    alt="remix"
    width="70%"
    height="automatic"
/>
...
<img
    src={require('/static/img/verify_success.png').default}
    alt="remix"
    width="20%"
    height="automatic"
/>
