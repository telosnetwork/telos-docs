...
For a step by step guide of how to create an account, set up an app, and access your developer dashboard see ORE ID's [docs](https://docs.oreid.io/ore-id/blockchains/telos-cloud-wallet/quickstart).
