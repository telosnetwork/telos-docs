...
<img
    src={require('/static/img/Telos.png').default}
    alt="EVM Architecture"
    width="70%"
    height="automatic"
/>
...
<img
    src={require('/static/img/Telos - Telos EVM design.png').default}
    alt="Telos EVM dapp design"
    width="70%"
    height="automatic"
/>
...
* EVM smart contract uses TLOS token as gas instead of ETH. More can be read on gas fees [here](/evm/about/gas-fees).
