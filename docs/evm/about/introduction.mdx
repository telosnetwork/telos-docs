...
2. **Speed:** With block times of 0.5 seconds and efficient transaction processing, Telos EVM boasts industry-leading speeds of over [15,000 TPS](https://hellotelos.medium.com/telos-breaking-evm-transaction-records-f7a2a2de098d).
...
To learn more about the architecture of the Telos EVM read our article [here](./overview-and-architecture.md)
