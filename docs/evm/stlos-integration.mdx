...
- Rewards are sent to the contract every 30 minutes by the Telos Zero [exrsrv.tf contract](https://github.com/telosnetwork/telos-distribute/blob/stlos/src/eosio.tedp.cpp) which increases the TLOS price of sTLOS over time. 
