...
title: Indexing With Flair
description: Learn how to index the Telos EVM with Flair
...
<a href="https://docs.flair.dev/" target="_blank">
<img
    src={require('/static/img/flair-architecture.png').default}
