...
This page explains the fundamental concepts behind Telos Privacy. For full technical details, see the [Developer Reference](../technical/architecture).
...
You interact with the relayer via its [REST API](../technical/relayer). In the zkWallet UI, this happens automatically.
