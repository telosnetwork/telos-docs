...
The zkBob protocol, on which zkTelos is based, has undergone third-party security audits. Audit reports are available in the [zkBob documentation](https://docs.zkbob.com/resources/security-audit).
