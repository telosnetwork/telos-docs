...
The zkTelos protocol smart contracts and circuits have undergone third-party security audits. Audit reports are available in the [zkBob documentation](https://docs.zkbob.com/resources/security-audit).
